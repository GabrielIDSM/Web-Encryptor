...
class EnigmaSwissKAirForce extends Component {
  constructor(props) {
    super(props)
  ...
  submitHandler = (e) => {
    ...
    axios.post('https://encryptorapi-gabrielidsm.herokuapp.com/message/enigmaswisskairforce', this.state.request)
      .then(response => {
  ...
  render() {
    return (
      <div className="EnigmaModelTypeOne">
        <Navbar/>
        <h2 className="MachinesTitles">Enigma Swiss-K Air Force</h2>
        <hr className="Lines" />
