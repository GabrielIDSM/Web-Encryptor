...
class EnigmaZahlwerkG312 extends Component {
  constructor(props) {
    super(props)
  ...
  submitHandler = (e) => {
    ...
    axios.post('https://encryptorapi-gabrielidsm.herokuapp.com/message/enigmazahlwerkg312', this.state.request)
      .then(response => {
        this.setState({
  ...
  render() {
    return (
      <div className="EnigmaModelTypeOne">
        <Navbar />
        <h2 className="MachinesTitles">Enigma Zählwerk G-312</h2>
        <hr className="Lines" />
