...
class EnigmaZahlwerkDefault extends Component {
  constructor(props) {
    super(props)
  ...
  submitHandler = (e) => {
    ...
    axios.post('https://encryptorapi-gabrielidsm.herokuapp.com/message/enigmazahlwerkdefault', this.state.request)
      .then(response => {
        this.setState({
